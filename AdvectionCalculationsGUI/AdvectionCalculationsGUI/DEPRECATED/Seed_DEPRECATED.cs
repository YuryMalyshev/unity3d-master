...
public class Seed_DEPRECATED : Point
{
	private List<Point> points = new List<Point>();
	private readonly double radius;
	public double FTLE { get; set; }
	public int Step { get; }
	public Seed_DEPRECATED(Point center, float radius, InputDataSet_DEPRECATED ds) : base(center)
	{
		this.radius = radius;
	...
	public Seed_DEPRECATED(Point self, List<Point> points, double radius) : base(self)
	{
		this.radius = radius;
		this.points = points;
	}
